...
contract SimpleBank {
    ...
    modifier RequireEnrolled(address enrolledAddress) {
        require(enrolled[enrolledAddress]);
        _;
    }
    modifier WithinBalanceBounds(uint amount, address enrolledAddress) {
        require(amount <= balances[enrolledAddress]);
        _;
    }
    ...
    function withdraw(uint withdrawAmount)
        public
        RequireEnrolled(msg.sender)
        WithinBalanceBounds(withdrawAmount, msg.sender)
        returns (uint)
    {
